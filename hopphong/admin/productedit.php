         ...
         <form action="" method="post" enctype="multipart/form-data">
            <table class="form">               
                ...
                <tr>
                    ...
                    <td>
                        <img src="uploads/<?php echo $result_product['image'] ?>" width="50px" height="50px"/></br>
				...
				<tr>
                    ...
                    <td>
                        <select id="select" name="type">
                            <option>---Hinh thức hiển thị---</option>
                            <?php
                             if($result_product['type']==0){
                            
                            ?>    
                                <option selected value="1">Sản phẩm Nổi bậc</option>
                            ...
                            <?php
                             ...
                             {
                            ?>
                                <option  value="1">Sản phẩm Nổi bậc</option>
